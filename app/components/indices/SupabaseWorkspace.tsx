...
const SupabaseWorkspace: React.FC<SupabaseWorkspaceProps> = ({
  ...
  // Suppress unused-variable warnings for items used elsewhere or future use
  void showAdvanced;
  void deleteStatus;
  void refreshBios;
  void relatedOptions;
  void handleRelatedChange;
  void articleDetail;
            ...
            <div className="supabase-intros__editor">
              {selectedIntro ? (
                <>
                  ...
                  {/* Intro editor: no slug, image upload not needed for intros */}
      ...
      >
        ...
        <div className="supabase-workspace__editor">
          {selectedArticleId && formState ? (
            <>
              <div className="supabase-editor__content">
                <section className="supabase-editor__top">
                  ...
                  <div className="supabase-editor__details-grid supabase-editor__details-grid--wide">
                    <label className="supabase-editor__field supabase-editor__field--preview">
                ...
                <section className="supabase-editor__body">
                  <div className="supabase-editor__richtext-header">
                  ...
                  {/* Article body editor — slug passed so image uploads go to articles/{slug}/ */}
                  <SupabaseRichTextEditor
                ...
                <footer className="supabase-editor__footer">
                  ...
                  {isAdmin && (
                    ...
                    >
                      {deleteStatus === "deleting" ? "Suppression…" : "Supprimer l'article"}
                    </button>
                  )}
                </footer>
              </div>
            ...
            <div className="supabase-workspace__empty">
              {status === "loading" ? "Chargement…" : "Sélectionnez un article pour l'éditer."}
            </div>
          )}
        </div>
      </div>
          ...
          <aside className="supabase-workspace__sidebar">
            {bioEntries.map((entry) => (
              <button
                ...
                type="button"
                className={
                  selectedBioId === entry.id
                    ? "supabase-entry supabase-entry--active"
                    : "supabase-entry"
                }
                onClick={() => {
                  if (selectedBioId === entry.id) return;
                  setSelectedBioId(entry.id);
                }}
              >
                <span className="supabase-entry__title">{entry.name}</span>
                <span className="supabase-entry__preview">{entry.role ?? ""}</span>
              </button>
            ))}
          </aside>
          <div className="supabase-workspace__editor">
              ...
              <>
                <div className="supabase-editor__content">
                  <section className="supabase-editor__top">
                    <label className="supabase-editor__field supabase-editor__field--title">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setBioFormState((s) => s ? { ...s, name: e.target.value } : s)
                        }
                      />
                    </label>
                    <label className="supabase-editor__field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setBioFormState((s) => s ? { ...s, role: e.target.value } : s)
                        }
                      />
                    </label>
                    <label className="supabase-editor__field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setBioFormState((s) => s ? { ...s, rank: e.target.value } : s)
                        }
                      />
                    </label>
                    <label className="supabase-editor__field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setBioFormState((s) => s ? { ...s, portraitBase: e.target.value } : s)
                        }
                      />
                    </label>
                    <label className="supabase-editor__field">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setBioFormState((s) => s ? { ...s, bioText: e.target.value } : s)
                        }
                      />
                    </label>
                  </section>
                  <footer className="supabase-editor__footer">
                    ...
                    {bioStatus && (
                      <span className="supabase-editor__status">{bioStatus}</span>
                    )}
                  </footer>
                </div>
              </>
            ) : (
              <div className="supabase-workspace__empty">Sélectionnez une bio.</div>
            )}
          </div>
        </div>
      )}
